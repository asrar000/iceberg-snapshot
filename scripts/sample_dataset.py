...
STABLE_ROWS = 600
MUTABLE_ROWS = 250
UNIQUE_ROWS_PER_FILE = ROWS_PER_FILE - STABLE_ROWS - MUTABLE_ROWS

if UNIQUE_ROWS_PER_FILE <= 0:
    raise ValueError("Snapshot row groups must add up to less than ROWS_PER_FILE.")
